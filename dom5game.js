  ...
  rw.deleteDirContents(path, ["", ".2h", ".trn", ".txt"], function(err)
  {
    ...
    kill(game, function(err)
    {
      ...
      if (fs.existsSync(`${config.statusPageBasePath}/${game.name}_status`) === true)
      {
        ...
        {
          cb(`The game was restarted, but the old timer file generated by Dominions could not be deleted. This is... probably fine. You need to launch the game's process again, though.`);
          return;
        }
      }
