      ...
      setTimeout(function()
      {
        ...
        isPortInUse(game.port, function(returnVal)
        {
          ...
          if (attempts >= maxAttempts)
          {
            if (returnVal === false && game.instance != null)
            {
              let err = `The game instance could not be killed after ${maxAttempts}, but the port was preed up.`;
            ...
            {
              let err = `The game instance was terminated, but the port is still in use. You might have to wait a bit.`;
            ...
            {
              let err = `The game instance could not be terminated and the port is still in use. You might have to wait a bit.`;
